# Tick Every — English Appstore listing

## Short summary

A repeating haptic timer that counts cycles so you can stay on rhythm without looking at the screen.
...
- repeating timer with no fixed end;
...
Tools & Utilities (`tools` in the CLI)
